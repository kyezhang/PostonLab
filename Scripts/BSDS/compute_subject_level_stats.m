...
% 						however, if the the pca_flag is not saved in the trained model it should be provided as
%						either 0 or 1. pca_flag=0 means the noise variance is allowed to vary across dimensions
%						and pca_flag=1 means the noise variance is the same across dimensions
%Outputs:
