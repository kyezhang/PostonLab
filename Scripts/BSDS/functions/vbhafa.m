...
if nargin==8 % given hparams, also perhaps params
      ...
      Qns = net.kmeans_init.Qns_kmeans;
      ...
      F = -inf;
      Fhist = [];
      [Wa,Wpi,Qns] = initPoteriors(Ycell,nStates, 'group');
      warning('on')
      Wa_kmeans = Wa;
      Wpi_kmeans = Wpi;
      Qns_kmeans = Qns;
      ...
      net.kmeans_init.Qns_kmeans= Qns_kmeans;
...
nSubjs = length(Ycell);
for subj = 1:nSubjs
      QnsCell{subj} = Qns(n/nSubjs*(subj-1)+1:subj*n/nSubjs, :);
end
